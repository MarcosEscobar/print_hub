...
class PrintsControllerTest < ActionController::TestCase
  ...
  test 'should get admin index' do
    new_user = new_generic_operator

    @print.update_column(:user_id, new_user.id)
  ...
  test 'should get admin pending index' do
    ...
    Print.pending.take.update_column(:user_id, new_user.id)
  ...
  test 'should get admin scheduled index' do
    ...
    Print.scheduled.take.update_column(:user_id, new_user.id)
  ...
  test 'should get admin pay later index' do
    ...
    Print.pay_later.take.update_column(:user_id, new_user.id)
